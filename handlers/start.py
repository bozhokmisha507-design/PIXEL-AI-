...
async def send_welcome_message(chat_id: int, first_name: str, bot):
    welcome_text = (
        ...
        f"🎬 *Видео*\n"
        f"• Создание видео из фото по описанию\n"
        f"• Sora 2 Pro (премиум) – 280₽ / 8 жетонов, 4 сек, 720p\n"
        f"• Wan 2.7 (эконом) – 120₽ / 4 жетона, 4 сек, 720p\n\n"
        f"💎 *Жетоны*\n"
        f"• Пакет 20 жетонов – 700₽\n"
        f"• Gemini = 1 жетон, GPT Image / Nano Banana = 2 жетона\n"
        f"• Видео: Sora 2 Pro = 8 жетонов, Wan 2.7 = 4 жетона\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "3. Выбери модель:\n"
        "   • Sora 2 Pro (премиум) – 280₽ / 8 жетонов, 4 сек, 720p\n"
        "   • Wan 2.7 (эконом) – 120₽ / 4 жетона, 4 сек, 720p\n"
        "4. Оплати или используй жетоны.\n\n"
        "**💎 Жетоны**\n"
